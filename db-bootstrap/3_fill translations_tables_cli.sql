...
BEGIN
    ...
    WHILE j < entity_table_length DO
    	...
    	SET @query = CONCAT('INSERT INTO `translations`(`ISO`, `content`) VALUES (\'', iso_from_entity ,'\',\'', IFNULL(@description_content_replaced, 'NULL'), '\')') ;
	    PREPARE statement FROM @query;
	    EXECUTE statement;
	    DEALLOCATE PREPARE statement;
	...
	SET j = 0;
 	...
 	WHILE j < entity_table_length DO
    	...
    	SET @query = CONCAT('INSERT INTO `translations`(`ISO`, `content`) VALUES (\'', iso_from_entity ,'\',\'', IFNULL(@label_content_replaced, 'NULL'), '\')') ;
	    PREPARE statement FROM @query;
	    EXECUTE statement;
	    DEALLOCATE PREPARE statement;
...
BEGIN
    ...
    WHILE j < entity_table_length DO
    	...
    	SET @query = CONCAT('INSERT INTO `translations`(`ISO`, `content`) VALUES (\'', iso_from_entity ,'\',\'', IFNULL(@name_content_replaced, 'NULL'), '\')') ;
	    PREPARE statement FROM @query;
	    EXECUTE statement;
	    DEALLOCATE PREPARE statement;
...
BEGIN
    ...
    WHILE j < entity_table_length DO
    	...
    	SET @query = CONCAT('INSERT INTO `translations`(`ISO`, `content`) VALUES (\'', iso_from_entity ,'\',\'', IFNULL(@comment_content_replaced, 'NULL'), '\')') ;
	    PREPARE statement FROM @query;
	    EXECUTE statement;
	    DEALLOCATE PREPARE statement;
...
CREATE PROCEDURE `duplicate_data_instances_risks_op`()
	BEGIN
		...
		WHILE j < entity_table_length DO
			...
			SET @query = CONCAT('INSERT INTO `translation_language` (`translation_id`, `instances_risks_op_string_id`) VALUES (', @new_translation_id ,',', @current_entity_description_id ,')');
		...
		WHILE j < entity_table_length DO
			...
			SET @current_entity_id = (SELECT `id` FROM vulnerabilities LIMIT 1 OFFSET j);
			SET @current_entity_label_id = (SELECT `risk_cache_label_translation_id` FROM instances_risks_op WHERE `id` = @current_entity_id);
      ...
      PREPARE statement FROM @query;
			...
			SET @query = CONCAT('INSERT INTO `translation_language` (`translation_id`, `instances_risks_op_string_id`) VALUES (', @new_translation_id ,',', @current_entity_label_id ,')');
